# Manual de Instação do Conecteup em Localhost
...
3. Entrar no diretório backend do chatup-free
...
11. Entrar no diretório frontend do chatup-free

```bash
cd chatup-free/frontend
``` 
...
REACT_APP_PAGE_TITLE=conecteup.com
PORT=3333
```  
