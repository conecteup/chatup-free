    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          >
            {i18n.t("mainDrawer.appBar.message.hi")} {user.name}, {i18n.t("mainDrawer.appBar.message.text")} {system.name || "Conecteup"}
          </Typography>
          ...
          <div>
            ...
            >
              ...
              <span className={classes.systemCss}>
                <Link color="inherit" href={system.url || "https://github.com/conecteup/chatup-free"}>
                  v{systemVersion}
                </Link>
              </span>
            </Menu>
